function solve() {
  ...
  function add() {
    addValue = JSON.parse(document.getElementsByTagName('textarea')[0].value);
    for (let item of addValue) {
  ...
  function endDay() {
    ...
    document.getElementsByTagName('button')[0].removeEventListener('click', buy);
    document.getElementsByTagName('button')[0].removeEventListener('click', endDay);
  }
}